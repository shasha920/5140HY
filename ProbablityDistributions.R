...
#Example3-1
#Grear Tire Company developed a new tire to be sold throughout the nation. Grear’s managers believe that the mileage guarantee offered with the tire will be an important factor in the acceptance
#of the product. Before finalizing the tire mileage guarantee policy, Grear’s managers want probability information about 𝑥𝑥 = number of miles the tires will last. After road tests, Grear’s 
#engineering group estimated that 𝜇= 36500 miles and 𝜎= 5000 miles. What percentage of the tires can be expected to last more than 40000 miles?
#Grear wants to provide a discount on replacement tires if the original tires do not provide the guaranteed mileage. What should the guarantee mileage be if Grear wants no more than 10% of the tires to be eligible for the discount guarantee?
...
#Examples3-2
#A company has a history of making errors in 10% of its invoices.A sample of 100 invoices has been taken.
